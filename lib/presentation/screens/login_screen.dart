...
//         await user
//             .sendEmailVerification(); // Gửi lại email xác thực nếu chưa xác minh
...
//         await FirebaseAuth.instance.signOut(); // Đăng xuất khỏi phiên đăng nhập
//         return;
//       }

//       // Nếu đã xác thực email thì chuyển đến màn hình chính
...
//             //   child: Center(
//             //     child: Image.asset(
//             //       'assets/images/GET-logo-white.png',
//             //       width: 200,
//             //     ),
//             //   ),
//             // ),
...
//                           Text('Sign in to continue.',style: TextStyle(fontWeight: FontWeight.bold),),
